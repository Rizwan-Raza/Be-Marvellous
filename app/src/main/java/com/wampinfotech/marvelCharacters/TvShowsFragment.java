 ...
 */
public class TvShowsFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Characters>>, FilterableFragment {
     ...
     */
    private static final int TV_SHOWS_LOADER_ID = 5;
    /**
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        loaderManager.initLoader(TV_SHOWS_LOADER_ID, null, this);
        return _RootView;
    }
    ...
    public Loader<List<Characters>> onCreateLoader(int i, Bundle bundle) {
        ...
        String orderDir = "asc", orderField = "release_date";
        if (order != null) {
        ...
        uriBuilder.appendQueryParameter("entityType", "tv");
    ...
    public void onLoadFinished(@NonNull Loader<List<Characters>> loader, List<Characters> chars) {
        ...
        _EmptyStateTextView.setText(R.string.no_tv_shows);
