 ...
 */
public class ItemsFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Characters>>, FilterableFragment {
...
//            _EmptyStateTextView.setText(R.string.no_internet_connection);
    ...
    public Loader<List<Characters>> onCreateLoader(int i, Bundle bundle) {
        ...
        uriBuilder.appendQueryParameter("entityType", "item");
    ...
    public void onLoadFinished(@NonNull Loader<List<Characters>> loader, List<Characters> chars) {
        ...
        _EmptyStateTextView.setText(R.string.no_items);
